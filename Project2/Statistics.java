...
public class Statistics extends Observation implements DateTimeComparable
{
    ...
    {
        // TODO
        return String.format("yyyy-MM-dd'T'HH:mm:ss z", utcDateTime.get(Calendar.YEAR), utcDateTime.get(Calendar.MONTH),
    ...
    {
        // TODO
        return String.format("yyyy-MM-dd'T'HH:mm:ss z", (Calendar.YEAR), (Calendar.MONTH), (Calendar.DAY_OF_MONTH),
